...
const NewSession = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground mb-2">Create New Session</h1>
        <p className="text-muted-foreground">Set up your interview practice session</p>
      </div>
            ...
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex items-center gap-2">
                ...
                <span className={cn(
                  ...
                  {s === 1 ? 'Choose Role' : s === 2 ? 'Select Level' : 'Options'}
                </span>
            ...
            <CardContent>
              ...
              {step === 3 && (
                <div className="space-y-6">
                  ...
                  {/* Time Limit */}
                  <div>
                    <Label className="mb-3 block">Time Limit</Label>
                    <div className="grid grid-cols-2 gap-3">
                  ...
                  {/* Answer Mode */}
                  <div>
                    <Label className="mb-3 block">Answer Mode</Label>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-foreground capitalize">{config.level}</span>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-foreground">
                    {timeLimits.find(t => t.id === config.timeLimit)?.name}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Answer Mode</span>
                  <span className="font-medium text-foreground capitalize">{config.answerMode}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Difficulty</span>
                  <span className="font-medium text-foreground capitalize">{config.difficulty}</span>
                </div>
              </div>
