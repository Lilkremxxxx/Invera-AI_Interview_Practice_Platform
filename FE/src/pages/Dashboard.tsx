...
const Dashboard = () => {
  ...
  const copy = {
    ...
    noSessionsTitle: language === 'vi' ? 'Chưa có phiên luyện tập nào — hãy bắt đầu! 🚀' : 'No sessions yet. Let’s get started! 🚀',
    ...
    createFirstSession: language === 'vi' ? 'Tạo phiên đầu tiên' : 'Create your first session',
    roleTipTitle: language === 'vi' ? 'Chọn vai trò phù hợp' : 'Pick the right role',
