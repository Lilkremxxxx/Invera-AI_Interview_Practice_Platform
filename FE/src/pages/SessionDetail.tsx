    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">{session.role[language]}</h1>
            <p className="text-muted-foreground">
              {session.level[language]} • {session.date} • {session.duration[language]}
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <p className="text-2xl font-bold text-foreground">{session.duration[language]}</p>
